      ...
      <div class="col-sm-8 clearfix" >
        ...
        <div class="cus-login-section clearfix">
          ...
          <div class="cus-login-part2 clearfix">
            ...
            <div > <a href="#"><span class="np-right-caret"></span>Forgot Password?</a>  </div>
          </div>
		  <div class="login-link"><a href="#" class="np-mobile-fix loginbtn"><!--<span class="np-right-caret"></span>-->Login</a></div>
        </div>
      </div>
    </div>
  </div>
